/**
 Copyright (c) 2014-2015 Alexander Savochkin
...
public class SearchFailureJSONResponse {
    ...
    public static JSONObject create (String severity, String strong, String message) {
